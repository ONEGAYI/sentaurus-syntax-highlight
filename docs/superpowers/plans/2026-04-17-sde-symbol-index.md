# SDE 符号索引与语义分析（Phase 3 MVP）实施计划 ✅ 已完成
...
- [x] **Step 1: 编写 resolveSymbolName 的测试**
...
- [x] **Step 3: 实现 resolveSymbolName + extractSymbols 骨架**
...
- [x] **Step 1: 为 create-* 系列函数添加 symbolParams**
...
- [x] **Step 2: 为 Contact 定义和引用函数添加 symbolParams**
...
- [x] **Step 3: 为 sde/sdepe/sdeicwb 系列函数添加 symbolParams**
...
- [x] **Step 4: 为 sdedr 引用函数添加 symbolParams（含 modeDispatch）**
...
- [x] **Step 3: 实现 region-undef-diagnostic.js Provider**
...
- [x] **Step 3: 实现 symbol-completion.js Provider**
...
- [x] **Step 3: 实现 symbol-reference-provider.js**
...
- [x] **Step 1: 在 extension.js 顶部添加 require**
...
- [x] **Step 3: 注册 region-undef-diagnostic Provider**
...
- [x] **Step 4: 注册 symbol-completion Provider**
...
- [x] **Step 5: 注册 symbol-reference Provider**
...
- [x] **Step 1: 在 display_test 中添加符号索引测试用例**
...
- [x] **Step 2: 在 Extension Development Host 中手动验证**
...
- [x] **Step 2: 更新 CLAUDE.md 文件树和架构描述**
