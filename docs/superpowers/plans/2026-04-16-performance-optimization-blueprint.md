...
| # | 优化项 | 文件 | 改动量 | 影响 |
|---|--------|------|--------|------|
| 3 | 重构 buildScopeMap 算法 | `src/lsp/tcl-ast-utils.js` | ~150 行重写 | **极高** |
| 6 | 懒加载关键词和文档 JSON | `src/extension.js` | ~80 行改 | **高** |
| 7 | 异步文件读取 | `src/extension.js` | ~30 行改 | **中** |
| 16 | 预计算行偏移表 | `src/lsp/scheme-parser.js` | ~20 行 | **中** |
