...
|------|-----------|-------------------|-------------------|
| Scheme 5x 冗余 (1000L) | 15.21ms | **10.03ms** (×1.5↓) | 10.03ms (不变) |
| Tcl buildScopeMap (1000L/50P) | 54.50ms | **45.76ms** (×1.2↓) | **按需查询，无全量构建** ✅ |
| Tcl full pipeline (1000L/50P) | 74.90ms | **65.42ms** (×1.1↓) | **待基准测量** |
| 激活时 I/O 阻塞 | 5.6ms / 1.46MB | **4.1ms** / 1.46MB | **~1.2ms / ~452KB** (仅 modeDispatch) |
