...
用法:
    python scripts/syntax/split_long_matches.py                  # 处理 syntaxes/ 下所有文件
    python scripts/syntax/split_long_matches.py path/to/dir      # 处理指定目录
    python scripts/syntax/split_long_matches.py --max-alts 50    # 自定义每批最大替代项数
"""
