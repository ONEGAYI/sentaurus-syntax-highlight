        ...
        if (langId === 'sde') {
            ...
            if (!_docsCache[langId]) {
                const langSpecificDocs = (() => {
                    ...
                    if (langId === 'emw') return loadDocsJson('emw_command_docs.json', useZh) || {};
                    return {};
                })();
                            ...
                            if (!isComment) {
                                ...
                                if (scopeNameItems.length > 0 && scopeNameItems[0].kind === 'scopeName') {
                                    ...
                                    parConverted = scopeNameItems.map(pi => {
                                        ...
                                        if (pi.filePath) {
                                            item.documentation = new vscode.MarkdownString(vscode.l10n.t('hover.source', pi.source, path.basename(pi.filePath)));
                                        }
                                        return item;
                                    });
                                    ...
                                    if (parItems.length > 0) {
                                        ...
                                        parConverted = parItems.map(pi => {
                                            ...
                                            if (pi.parentPath || pi.filePath) {
                                                ...
                                                if (pi.filePath) {
                                                    parts.push(vscode.l10n.t('hover.source', pi.source, path.basename(pi.filePath)));
                                                } else {
                                                    parts.push(vscode.l10n.t('hover.sourceNoFile', pi.source));
                                                }
